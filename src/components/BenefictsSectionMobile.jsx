...
export default function BenefictsSectionMobile() {
    ...
    return (
        <div >
            <ReactTextTransition
              ...
              style={{fontSize: "40px", marginBottom: "40px", fontFamily: "monospace"}}
              delay={300}
              inline
            />
            <ReactTextTransition
              ...
              springConfig={presets.gentle}
              style={{fontSize: "16px", paddingTop: "40px", textAlign: "center", fontFamily: "monospace"}}
            />
        </div>
    )
}
